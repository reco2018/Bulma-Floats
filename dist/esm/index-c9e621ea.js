...
import { openBlock, createBlock, Transition, withCtx, createElementVNode, normalizeClass, createElementBlock, createCommentVNode, toDisplayString, resolveDynamicComponent, defineComponent, createApp } from 'vue';
  ...
  return (openBlock(), createBlock(Transition, { name: _ctx.animation }, {
    default: withCtx(() => [
      createElementVNode("div", {
        ...
        createElementVNode("div", {
          class: normalizeClass(["modal-card", {'px-3': !_ctx.isFullScreen, 'fullScreenModal': _ctx.isFullScreen}])
        }, [
...
export { AlertProgrammatic as A, script as s };
